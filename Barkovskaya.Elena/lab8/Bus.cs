...
namespace labr8
{
    class Bus : MarkCar, ICarInfo
    {
        ...
        string[] jobs = new string[] { "POHORONNYI", "Organisation Bus", "School bus", "City bus"};
        ...
        {
            Notify?.Invoke("Now you get eandom JOB. Say \"JESUS Christ\" to up you chance to be Jesus Helper (POHORONNYI type)");
