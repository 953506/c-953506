...
namespace Lab8
{
    public delegate void ArgumentExceptionHandler(ArgumentException exception);
    ...
    class Program
    {
        ...
        static void Show(List<IGun> weapons)
        {
            int i = 1;
            Console.WriteLine("  Model\tCaliber\tMaxAmmo");
            foreach(IGun gun in weapons)
            {
        ...
        {
            MenuHandler menu = new MenuHandler(Menu);
            uint a, ammo, K = 1, k;
            bool exit = false, first = true;
            List<IGun> weapons = new List<IGun>();
                                ...
                                case 1:
                                    {
                                        ...
                                        Gun.Notify += delegate (ArgumentException exception)
                                        {
                                            Console.ForegroundColor = ConsoleColor.Red;
                                            Console.WriteLine(exception);
                                        };
                                        Gun.Notify += exception => Console.ResetColor();
                                        weapons.Add(Gun);
                                        break;
                                    }
                                case 2:
