        ...
        public static void ItsCoronaTime()
        {
            ...
            switch (menu)
            {
                case "1":
                    ...
                    break;
                case "2":
                    MessageBox(0, "~3 million. \n\n April, 2020", "The number of infected", 0);
                    break;
                case "3":
                    MessageBox(0, "~820 thousand \n\n April, 2020", "The number of reovered", 0);
                    break;
                case "4":
                    MessageBox(0, "~200 thousand \n\n April, 2020", "The number of dead", 0);
                    break;
                case "5":
                    MessageBox(0, "1. Wash your hands often with soap and water for at least 20 seconds; \n2. Use a hand sanitizer that contains at least 60% alcohol; \n3. Avoid touching your eyes, nose, and mouth with unwashed hands; \n4. Stay home as much as possible; \n5. Clean AND disinfect frequently touched surfaces daily.", "Safety precautions", 0);
                    break;
                case "6":
                    MessageBox(0, "The most common symptoms of COVID-19 are fever, tiredness, and dry cough. Some patients may have aches and pains, nasal congestion, runny nose, sore throat or diarrhea. These symptoms are usually mild and begin gradually. Some people become infected but don’t develop any symptoms and don't feel unwell. Most people (about 80%) recover from the disease without needing special treatment. Around 1 out of every 6 people who gets COVID-19 becomes seriously ill and develops difficulty breathing. Older people, and those with underlying medical problems like high blood pressure, heart problems or diabetes, are more likely to develop serious illness. People with fever, cough and difficulty breathing should seek medical attention.", "The symptoms of COVID-19", 0);
                    break;
                case "7":
                    MessageBox(0, "If you have a fever, cough and difficulty breathing, seek medical attention and call in advance. Follow the directions of your local health authority.", "I have symptoms of coronavirus! What to do? ", 0);
                    break;
                case "8":
                    MessageBox(0, "Honestly, it’s impossible to say if and when the coronavirus will die down because it’s a totally new virus, and therefore unpredictable. But researchers do look at past pandemics to make very baseline predictions about when it might end. And in the past, pandemics have typically lasted between 12 and 36 months.", "Baseline predictions", 0);
                    break;
                case "9":
                    Console.WriteLine("I hope the information was helpful. Goodbye!", 0);
                    Environment.Exit(-1);
                    break;
                default:
