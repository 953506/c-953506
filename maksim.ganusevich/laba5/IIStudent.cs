...
{
    class IIStudent: StudentBSUIR
    {
        public IIStudent(): base() 
        {
        ...
        public IIStudent(string name, string surname, string nationality, Gender gender, int day, int month, int year) :
