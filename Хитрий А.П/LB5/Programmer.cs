...
{
    protected string[] _programLanguage = new string[1];
    ...
    {
        WriteLine(" {0} {1}, {2}, возраст: {3}, {4}, {5}", _Name.Name, _Name.Surname, Sex, Age, Nationality, Job);
    }
    ...
    public void ChangeString()
    {
        ...
        { 
            ...
            {
                case 0:  return;
                case 1:  _Name.Name =ReadLine(); break;
                case 2:  _Name.Surname = ReadLine(); break;
